The Cygwin distribution contains software under several licenses: many tools are covered by the GNU GPL, some parts are public-domain, and others use an X11/MIT-style license. The Cygwin site explicitly states this mix.
- Cygwin licensing page: `https://www.cygwin.com/licensing.html`. 
